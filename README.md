...
| GET/PUT/DELETE | `/api/chat/conversations/:id` | details with `members[]` (each with `online`, `last_seen_at`, read and delivered pointers) / rename a group (owner) / leave a group, or delete a direct chat on your side |
