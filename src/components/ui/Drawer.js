...
export default function Drawer({ open, onClose, title, description, children, footer, width = "w-[380px]", className }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[90]">
      ...
      >
        <div className="ui-drawer-head flex items-start justify-between gap-4 border-b border-line px-5 py-4">
          <div>
        ...
        {footer ? <div className="ui-drawer-foot border-t border-line px-5 py-3">{footer}</div> : null}
      </aside>
    </div>,
    document.body
  );
